...
<head>
	<!-- Version 2.0, Created 2010-03-05, Modified 2015-05-20 -->
	...
	<div id="sectionprojects" class="section printhide">
		...
		<div id="panels">
			...
			<div class="panel-content">
				...
				<ul>
					<li><a href="http://pushboard.appspot.com/pushboard">Push Board Game (HTTP Server Push aka Comet, HTML 5, Java EE, JPA)</a></li>
					...
					<li style="display:none;"><a href="http://ucf-sage.pbworks.com/Independent-Image-Gallery">Image Gallery Component</a></li>
				</ul>
				<div>Source Codes</div>
				<ul>
					<li><a href="https://github.com/williamchang/pushboard/blob/master/war/_assets/js/jquery.wcBoardGame.js" class="bold">[JS]</a> <a href="http://github.com/williamchang/pushboard">Push Board Game (HTTP Server Push aka Comet, HTML 5, Java EE, JPA)</a></li>
